...
- Saved reviews and topic updates: implemented locally; release acceptance pending. Browser-local saves/follows, explicit account sync, private revision-checked persistence, and publication-gated updates are described in [reader-library.md](reader-library.md). Real MongoDB/backend/built-browser checks cover restart persistence, isolation, publication readiness and reader interactions. This is not yet a public delivery claim.
