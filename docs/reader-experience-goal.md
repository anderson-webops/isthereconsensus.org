...
- Ten reading guides: all ten subjects are authored, integrated, and locally validated, with the reading/discovery surface and evidence checks described in [reading-guide-evidence.md](reading-guide-evidence.md). The first three (caffeine, supplements, energy choices) were published in v1.17.0. The final seven (sleep, exercise, vaccines, nutrition, climate attribution, evolution, and interpreting medical evidence) require CI and public release acceptance before being counted as delivered.
