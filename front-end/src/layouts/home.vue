...
.site-footer__appearance {
	...
	border-radius: 999px;
	background: color-mix(in srgb, var(--consensus-elevated-surface) 82%, transparent);
...
.site-footer__appearance :deep(.palette-switcher__button) {
	width: 26px;
	height: 26px;
}
...
:global(.dark) .site-footer__appearance {
