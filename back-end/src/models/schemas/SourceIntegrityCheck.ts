...
import type { SourceIntegrityOutcome, SourceIntegritySignal } from "../../utils/sourceIntegrity.js";
import type { ClaimSourceCitationStatus } from "./ClaimSource.js";
import mongoose, { Schema } from "mongoose";
import { SOURCE_INTEGRITY_OUTCOMES } from "../../utils/sourceIntegrity.js";
...
const sourceIntegritySignalSchema = new Schema<SourceIntegritySignal>(
	{
...
const sourceIntegrityCheckSchema = new Schema<ISourceIntegrityCheck>(
	{
		...
		provider: { type: String, required: true, enum: ["crossref"], index: true },
