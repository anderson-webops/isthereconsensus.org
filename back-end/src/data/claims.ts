...
const rawClaims: SeedClaim[] = [
	...
	},
	{
		...
		stableCore: [
			...
			"A 2026 BMC Medicine network meta-analysis found moderate-potassium, low-sodium substitutes probably reduce systolic blood pressure by about 4.4 to 4.6 mm Hg and may reduce deaths or cardiovascular events, while noting that hard-outcome evidence is dominated by SSaSS.",
		...
		changeLog: [
			{
				...
				kind: "update",
				summary:
					"Added newer Consensus-located network meta-analysis evidence and removed overlapping combined potassium page to keep potassium coverage focused."
			},
			{
				date: "2026-07-03T05:21:00.000Z",
				kind: "publication",
		...
		sources: [
			...
			},
			{
				...
				stance: "supports",
				note:
					"Network meta-analysis of 34 randomized trials and 37,063 participants finding moderate-potassium, low-sodium substitutes probably lower systolic blood pressure and may reduce clinical events, while emphasizing that mortality and event evidence is predominantly driven by SSaSS.",
				order: 5
			}
		]
	},
